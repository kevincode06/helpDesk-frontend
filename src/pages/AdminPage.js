...
const AdminPage = () => {
    ...
    const fetchAllTickets = useCallback(async () => {
        try {
            const response = await fetch(`https://help-desk-backend-esr3.onrender.com/api/v1/tickets/my-tickets`, {
                headers : {
    ...
    const fetchAllUsers = useCallback(async () => {
        try {
            const response = await fetch(`https://help-desk-backend-esr3.onrender.com/api/v1/admin/users`, {
                headers : {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json'
                }
...
const fetchStats = useCallback(async () => {
    try {
        const response = await fetch(`https://help-desk-backend-esr3.onrender.com/api/v1/admin/stats`, {
            headers : {
                'Authorization': `Bearer ${token}`,
                'Content-Type': 'application/json'
            }
...
const handleTicketStatusUpdate = async (ticketId, newStatus) => {
    try {
        const response = await fetch(`https://help-desk-backend-esr3.onrender.com/api/v1/admin/tickets/${ticketId}/status`, {
            method: 'PATCH',
            headers: {
                'Authorization': `Bearer ${token}`,
               'Content-Type': 'application/json'
...
const handleDeleteTicket = async (ticketId) => {
    if (!window.confirm('Are you sure you want to delete this ticket?')) return;
        ...
        try {
            const response = await fetch(`https://help-desk-backend-esr3.onrender.com/api/v1/admin/tickets/${ticketId}`, {
                method: 'DELETE',
                headers: {
                    'Authorization': `Bearer ${token}`,
                   'Content-Type': 'application/json'
...
const handleUserRoleUpdate = async (userId, newRole) => {
    try {
        const response = await fetch(`https://help-desk-backend-esr3.onrender.com/api/v1/admin/users/${userId}/role`, {
            method: 'PATCH',
            headers: {
                'Authorization': `Bearer ${token}`,
               'Content-Type': 'application/json'
